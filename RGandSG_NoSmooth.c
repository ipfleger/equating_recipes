...
*/
  ...
  if(inall->method == 'M') 
    fprintf(fp,"Mean Equating with Random Groups Design");
  else if(inall->method == 'L') 
    fprintf(fp,"Linear Equating with Random Groups Design");
  else  
  ...
  if(inall->method != 'E'){        
    fprintf(fp,"      inter b  %12.5f\n",r->b[0]);
    fprintf(fp,"      slope a  %12.5f\n",r->a[0]);
  }
...
*/
  ...
  if(inall->method == 'M') 
    fprintf(fp,"Mean Equating with Single Groups Design");
  else if(inall->method == 'L') 
    fprintf(fp,"Linear Equating with Single Groups Design");
  else  
    fprintf(fp,"Equipercentile Equating with Single Groups Design");
